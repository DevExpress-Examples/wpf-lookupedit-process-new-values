...
Namespace HowToCreateLookUpEdit.ViewModel
	Public Class ProductListViewModel
		...
		Private Sub OnShowProductFormCommandExecute(ByVal parameter As String)
			If parameter Is String.Empty Then
				Return
			End If
			...
			Dim result As UICommand = DialogService.ShowDialog(dialogCommands:= New List(Of UICommand) (New UICommand() {addProductCommand, cancelProductCommand}), title:= "Add new row", viewModel:= p)
